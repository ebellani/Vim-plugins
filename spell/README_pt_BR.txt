...
pt-BR: Este dicionário está em desenvolvimento por Raimundo Moura e sua equipe. Ele está
...
======================
. Exclusão de 'biquine', 'pólens','insatisfazer' e 'pixação';
. Inclusão do gênero feminino de 'monossílabo' e 'dissílabo'; 
. Inclusão de 'atavicamente', 'antipichação','superpoder', arquiinimiga, multitarifação,
  multimedição e reencontros;
. Acentuação dos nomes próprios paroxítonos terminados "on";
. Inclusão de: atleticano(s), atleticana(s), periungueal, inusual, reagendada;
  Nomes próprios: Floramar e Nilmara.
  Termos médicos: distrofismo(s), isoecogênica(s), odontoexérese,  glicohemoglobina, 
  glicada, glicosilação, hiperandrogenismo, hipoandrogenismo, sinusobronquite,
  visceromegalia.Colaboração de Eduardo Mundim;
. Inclusão de 'automaquilagem', 'Montividiu', 'premier','extintora', 'anti-idade' e 
  'ZCIT';
. Inclusão de 'pentadáctilo', 'pentaédrico'. 'pentaedral', 'pentadecaedro', 
  'pentadecaedral', 'pentadecaédrico', 'penumbral', 'zwingliano' e 'zangadiço', 
  colaboração de David Cesarino;
. Inclusão de: acabadíssimo, adiantadíssimo, alteradíssimo, chocadíssimo, 
  concentradíssimo, desligadíssimo, emprestadíssimo, favorecidíssimo, folgadíssimo, 
  guardadíssimo, impressionadíssimo, iniciadíssimo, inteligentíssimo, ligadíssimo, 
  perdidíssimo, preocupadíssimo, preparadíssimo, prometidíssimo, quietíssimo, 
  sofisticadíssimo, tontíssimo, trabalhadíssimo, trancadíssimo, transformadíssimo, 
  transtornadíssimo, verdadeiríssimo;
. Inclusão de: cerúmen, cainiano, autoconfigurável, inicializável;
. Inclusão de 'irrazoabilidade',asseguratório, ajurídico e ressarcitória, colaboração de
  William Estrêla;
. Inclusão de: abstratização, academicização, academização, acutização,
  administracionalização, afervorização, agatização, agonização, alemanização, 
  alunização;
. Inclusão de 'hiperfixante','hipofixante','infradesnivelamento', 'antiperoxidase', 
  'antitireoglobulina', 'macrovasculopatia', 'ventilatório', colaboração de Eduardo 
  Mundim;
. Correção da conjugação dos verbos:faiscar, resfolegar, moscar, comprazer, moer, 
  remoer, roer, corroer, interver, tresler, requerer, concernir, escapulir, demolir, 
  zurrar, cacarejar, chilrear, crucifixar, gear, exemplar, balir, sobrestar, esmiuçar, 
  averiguar, obliquar, chover, arguir, redargüir, bramir, acontecer, coaxar. Colaboração
  de Jakson Alves de Aquino;
. Inclusão de microarranjo, macroarranjo, cDNA, mRNA, Bayes e Bayesiano, colaboração de
  Sandro Sperandei;
========================================================================================
